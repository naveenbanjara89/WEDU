  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'> 
        ...
        <div className='flex items-center gap-9'>
            ...
            <button className='bg-yellow-500 border cursor-pointer hover:bg-yellow-600 hover:scale-105 border-black text-black rounded font-bold px-4 py-2 '>Get Started</button>
        </div>
        </div>
    </div>
  )
